...
void allocate_TAgency(TAgency*& pointer, int num_services,int num_agencies) {
	int i = 0;
	pointer = new TAgency(num_services,num_agencies);//creating a list of travel agencies
...
void file_reader(ifstream& file, int num_agencies, int*& num_services) {
	TAgency** list;
	int num = 0;
	string buffer;
